...
const TypingInput = () => {
  ...
  return (
    ...
    >
      <input
        type="text"
        className="noto-sans tracking-[0.01em] text-(--gray) w-full px-4 py-2 rounded-lg border border-[#042741] bg-[#010b14] outline-transparent focus:outline-[#14426631] focus:outline-2 outline-offset-1"
