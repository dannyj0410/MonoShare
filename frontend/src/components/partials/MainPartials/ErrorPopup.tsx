const ErrorPopup = ({
  ...
  return (
    <div
      ...
      } z-50 animate-shake fixed electrolize text-base font-bold flex items-center bottom-0 right-0 mb-10 mr-20 px-3 py-3 rounded-lg border-red-400/30 border backdrop-blur-xs bg-red-400/15 cursor-pointer hover:opacity-70`}
      onClick={onClose}
    >
      <svg
