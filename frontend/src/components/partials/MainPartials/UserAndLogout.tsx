...
const UserAndLogout = () => {
  ...
  return (
    <div className="h-70 w-140 flex flex-col fixed pl-7 pb-4 left-0 bottom-0 items-start justify-end electrolize text-center tracking-wider text-base text-(--gray) blur-[0.5px] rounded-md transition-all duration-600 ease-in-out opacity-50 hover:opacity-100 z-0">
      <div
