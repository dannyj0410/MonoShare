const Features = () => {
  return (
    <section className="flex flex-col items-center mb-50 max-xl:max-w-[90vw]">
      ...
      <p className="electrolize max-sm:text-sm max-sm:mx-4 lg:w-135 text-center mb-15 text-(--gray)">
      ...
      <ul className="flex max-lg:flex-wrap justify-center cursor-default gap-16 max-xl:gap-4 max-xl:max-w-[90vw]">
        ...
        <li className="features-card group transition-all duration-300 ease-in-out max-xl:text-center">
          ...
          <p className="noto-sans text-sm font-medium text-(--gray)">
            You decide your secrets password, how long it stays live and who can
            access it.
          </p>
        </li>
        {/* Self-erasing links */}
