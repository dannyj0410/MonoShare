      ...
      <div className="max-w-200 pt-25 pb-15 mx-auto z-10">
        ...
        <section className="legal-section" id="p2">
          ...
          <p>
            ...
            automatically log certain technical data. This occurs at multiple
            layers of the stack:
          </p>
          <ul>
            <li>
              <strong>IP address</strong> — recorded across all infrastructure
              layers for rate limiting, abuse prevention, and security
              monitoring;
            </li>
            <li>
              <strong>HTTP request metadata</strong> — including request path,
              method, response code, response time, and timestamp;
            </li>
            <li>
            ...
            <li>
              <strong>Nginx access logs</strong> — our reverse proxy records
              each inbound HTTP request (IP address, request path, HTTP method,
              response code, response time, and User-Agent) for security
              monitoring, traffic diagnostics, and incident response. These logs
              are generated before a request reaches the application and are
              retained for security purposes only;
            </li>
            <li>
              <strong>fail2ban security logs</strong> — our intrusion prevention
              service monitors Nginx logs and application behaviour to detect
              suspicious patterns such as repeated failed authentication
              attempts or excessive request rates. IP addresses that trigger
              security rules are logged and may be temporarily blocked. These
              records are maintained strictly for security purposes and are not
              used for any other purpose;
            </li>
            <li>
              <strong>Application error logs</strong> — technical error data
              generated by the Node.js application layer for debugging and
              service improvement. Sentry is used in production to capture
              unhandled exceptions; error payloads are stripped of Secret
              content by design.
            </li>
          </ul>
          <p>
            We do not create user profiles from log data or use it for
            behavioural tracking, advertising, or analytics purposes.
          </p>
        ...
        <section className="legal-section" id="p3">
          ...
          <ul>
            ...
            <li>
              <strong>Automatically</strong> — Nginx access logs, fail2ban
              security records, and application-level logging of IP addresses,
              User-Agent strings, and request metadata when you access the
              Service;
            </li>
            <li>
        ...
        <section className="legal-section" id="p4">
          ...
          <table className="data-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Protecting Service integrity by rate-limiting requests at both
                  the Nginx proxy layer and the application layer using IP
                  addresses
                </td>
                <td>
              ...
              <tr>
                <td>
                  <strong>Security logging &amp; intrusion prevention</strong>
                </td>
                <td>
                  Nginx access logs, fail2ban ban records, and application error
                  logs maintained for security monitoring, incident response,
                  and automated blocking of abusive clients
                </td>
          ...
          <p>
            ...
            (primarily IP addresses for rate-limiting and security logging) and
            the direct benefit to all users of a protected service. IP addresses
            recorded by Nginx and fail2ban are used solely for security purposes
            and are not cross-referenced with Account data or used for
            profiling.
          </p>
        </section>
        ...
        <section className="legal-section" id="p5">
          ...
          <p>
            ...
            MonoShare's servers — including the Nginx reverse proxy layer.
          </p>
          ...
          <p>
            ...
            timestamps, slugs) and infrastructure logs (Nginx access logs,
            fail2ban records) are not protected by zero-knowledge encryption and
        ...
        <section className="legal-section" id="p6">
          ...
          <table className="data-table">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <strong>Nginx access logs (IP, path, User-Agent)</strong>
                </td>
                <td>
                  Typically 14–30 days, subject to server configuration.
                  Retained for security monitoring and incident response only.
                  Not linked to Account data.
                </td>
                <td>Legitimate interests (security)</td>
              </tr>
              <tr>
                <td>
                  <strong>fail2ban ban records (IP addresses)</strong>
                </td>
                <td>
                  Active bans are enforced for minutes to 24 hours depending on
                  the rule triggered. Underlying log entries are subject to the
                  same Nginx log retention period (14–30 days). Not linked to
                  Account data.
                </td>
                <td>Legitimate interests (security)</td>
              </tr>
              <tr>
                <td>
                  <strong>Application error logs</strong>
                </td>
                <td>
                  Retained for up to 30 days on the server. Sentry captures
                  production errors; retention follows Sentry's configured
                  project policy. No Secret content is included in error
                  payloads.
                </td>
                <td>Legitimate interests (service improvement / security)</td>
              </tr>
            </tbody>
          </table>
        ...
        <section className="legal-section" id="p7">
          ...
          <p>
            ...
            rights over your data. Current infrastructure components include:
          </p>
          <ul>
            <li>
              <strong>Virtual Private Server (VPS) Hosting</strong> — the
              Service runs on a VPS located in{" "}
              <strong>Frankfurt, Germany (European Union)</strong>. The server
              operates an Nginx reverse proxy for request routing, TLS
              termination, and network-level rate limiting, and fail2ban for
              automated intrusion prevention. Both services generate security
              logs as described in Section 2.3. All data processed on this
              server remains within the EEA.
            </li>
            <li>
              <strong>Managed database provider</strong> (MongoDB Atlas or
              equivalent) for encrypted persistent storage of Secret metadata
              and Account data.
            </li>
            <li>
              <strong>Sentry</strong> — used in production for application error
              monitoring. Error payloads are configured to exclude Secret
              content. Sentry operates under its own data processing terms.
            </li>
          </ul>
          <p>
          ...
          <p>
            The Service's primary server infrastructure — including the Nginx
            reverse proxy, fail2ban, and the application runtime — is hosted on
            a VPS in <strong>Frankfurt, Germany</strong>, which is within the
            European Economic Area (EEA). Personal data processed at this layer
            (including Nginx access logs and fail2ban records) therefore does
            not involve an international transfer.
          </p>
          <p>
            If our managed database provider processes personal data outside the
            EEA (for example, via geographically distributed database clusters),
            we ensure such transfers are subject to appropriate safeguards under
            Chapter V of the GDPR, including Standard Contractual Clauses (SCCs)
            approved by the European Commission or applicable adequacy
            decisions.
          </p>
        </section>
        ...
        <section className="legal-section" id="p9">
          ...
          <ul>
            ...
            <li>
              <strong>HTTPS/TLS</strong> for all data in transit, terminated at
              the Nginx reverse proxy;
            </li>
            <li>
              <strong>Nginx reverse proxy</strong> providing an additional layer
              of rate limiting and request filtering at the network edge, before
              traffic reaches the application server;
            </li>
            <li>
              <strong>fail2ban intrusion prevention</strong> for automated
              detection and temporary IP-level blocking of clients exhibiting
              suspicious behaviour, including repeated failed authentication
              attempts and excessive request patterns;
            </li>
            <li>
            ...
            <li>
              <strong>Application-level rate limiting</strong> on all sensitive
              endpoints using IP-based controls;
            </li>
            <li>
        ...
        <section className="legal-section" id="p10">
          ...
          <div className="rights-grid">
            ...
            <div className="right-card">
              ...
              <p>
                ...
                IP-level blocks by fail2ban are temporary technical security
                measures and do not constitute profiling under Article 22.
              </p>
            </div>
            <div className="right-card">
              <p className="right-card-title">
          ...
          <p>
            ...
            creation dates, expiration dates, recipient emails). Infrastructure
            logs (Nginx, fail2ban) record IP addresses only and are not
            cross-referenced with Account identity by us.
          </p>
        </section>
